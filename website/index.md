...
===  ":fontawesome-brands-apple: macOS"
    ...
    [Download .zip](https://github.com/cmelchior/jervis-ffb/releases/download/0.0.0000/jervis-fantasy-football-dev-0.0.0000-mac-aarch64.zip){ .md-button .md-button--primary }

===  ":fontawesome-brands-linux: Linux"

    The Linux client is distributed as a `.deb` package and should work on most Linux distributions without any issues.

    [Download .deb](https://github.com/cmelchior/jervis-ffb/releases/download/0.0.0000/christian-melchior-jervis-fantasy-football-dev_0.0.0000_amd64.deb){ .md-button .md-button--primary }
