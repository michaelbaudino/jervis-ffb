...
enum class Feature(val settingsKey: String) {
    ...
    ALWAYS_USE_BIG_HAND(SettingsKeys.JERVIS_AUTO_ACTION_ALWAYS_USE_BIG_HAND_VALUE),
    ALWAYS_USE_VERY_LONG_LEGS(SettingsKeys.JERVIS_AUTO_ACTION_ALWAYS_USE_VERY_LONG_LEGS_VALUE),
    USE_DIRTY_PLAYER_ON_ARMOUR(SettingsKeys.JERVIS_AUTO_ACTION_USE_DIRTY_PLAYER_ON_ARMOUR_ROLL_VALUE),
    USE_DIRTY_PLAYER_ON_INJURY(SettingsKeys.JERVIS_AUTO_ACTION_USE_DIRTY_PLAYER_ON_ARMOUR_ROLL_VALUE),
    USE_CATCH_SKILL_REROLL(SettingsKeys.JERVIS_AUTO_ACTION_USE_CATCH_SKILL_REROLL_VALUE),
    USE_PASS_SKILL_REROLL(SettingsKeys.JERVIS_AUTO_ACTION_USE_PASS_SKILL_REROLL_VALUE),
    ALWAYS_USE_SAFE_PASS(SettingsKeys.JERVIS_AUTO_ACTION_ALWAYS_USE_SAFE_PASS_VALUE),
    ALWAYS_USE_TACKLE_ON_STUMBLE(SettingsKeys.JERVIS_AUTO_ACTION_ALWAYS_USE_TACKLE_IN_STUMBLE_VALUE),
    ALWAYS_USE_TACKLE_ON_DODGE(SettingsKeys.JERVIS_AUTO_ACTION_ALWAYS_USE_TACKLE_TO_PREVENT_DODGE_VALUE),
    USE_SURE_HANDS_REROLL(SettingsKeys.JERVIS_AUTO_ACTION_USE_SURE_HAND_REROLL_VALUE),
    ALWAYS_USE_THICK_SKULL(SettingsKeys.JERVIS_AUTO_ACTION_ALWAYS_USE_THICK_SKULL_VALUE),
    ALWAYS_USE_LEAP_MODIFIER(SettingsKeys.JERVIS_AUTO_ACTION_ALWAYS_USE_LEAP_MODIFIER_VALUE),
    ALWAYS_USE_SIDESTEP(SettingsKeys.JERVIS_AUTO_ACTION_ALWAYS_USE_SIDESTEP_VALUE),
    ALWAYS_USE_GRAB(SettingsKeys.JERVIS_AUTO_ACTION_ALWAYS_USE_GRAB_VALUE),
    ALWAYS_USE_STAND_FIRM(SettingsKeys.JERVIS_AUTO_ACTION_ALWAYS_USE_STAND_FIRM_VALUE),
}
