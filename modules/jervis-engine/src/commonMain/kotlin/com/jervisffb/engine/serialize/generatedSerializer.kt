...
val generatedJervisSerializerModule = SerializersModule {
    ...
    polymorphic(com.jervisffb.engine.actions.GameAction::class) {
        ...
        subclass(com.jervisffb.engine.actions.SetBallPositionAction::class)
        subclass(com.jervisffb.engine.actions.SetPlayerPosition::class)
        subclass(com.jervisffb.engine.actions.SetPlayerStateAction::class)
