 ...
 */
object BreatheFireRoll: Procedure() {
    ...
    object RollDie : ActionNode() {
        override fun actionOwner(state: Game, rules: Rules): Team = state.getContext<BreatheFireContext>().attacker.team
        ...
        override fun applyAction(action: GameAction, state: Game, rules: Rules): Command {
            return castDiceRoll<D6Result>(action) { d6 ->
                ...
                return compositeCommandOf(
                    ...
                    ReportDiceRoll(DiceRollType.BREATHE_FIRE, d6),
        ...
        override fun applyAction(action: GameAction, state: Game, rules: Rules): Command {
            return when (action) {
                ...
                is RerollOptionSelected -> {
                    val rerollContext = UseRerollContext(DiceRollType.BREATHE_FIRE, action.getRerollSource(state))
                    compositeCommandOf(
