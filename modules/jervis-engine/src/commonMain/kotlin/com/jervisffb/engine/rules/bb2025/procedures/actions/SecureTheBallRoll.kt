 ...
 */
object SecureTheBallRoll : Procedure() {
    override fun isValid(state: Game, rules: Rules) {
        state.assertContext<SecureTheBallRollContext>()
    }
        ...
        override fun applyAction(action: GameAction, state: Game, rules: Rules): Command {
            return checkDiceRoll<D6Result>(action) { d6 ->
                ...
                return compositeCommandOf(
                    ...
                    ReportDiceRoll(DiceRollType.SECURE_THE_BALL, d6),
        ...
        override fun applyAction(action: GameAction, state: Game, rules: Rules): Command {
            return when (action) {
                ...
                is RerollOptionSelected -> {
                    val rerollContext = UseRerollContext(DiceRollType.SECURE_THE_BALL, action.getRerollSource(state))
                    compositeCommandOf(
