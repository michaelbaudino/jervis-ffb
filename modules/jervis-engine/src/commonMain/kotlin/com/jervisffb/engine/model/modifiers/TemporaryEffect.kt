 ...
 * [com.jervisffb.engine.commands.AddPlayerTemporaryEffect].
 *
...
enum class TemporaryEffectType {
    // Player is affected by Dodgy Snack (on the field). This is just a marker.
    // The stat modifiers are added separately.
    DODGY_SNACK,
...
data class TemporaryEffect(
    ...
    companion object {
        fun dodgySnack() = TemporaryEffect(TemporaryEffectType.DODGY_SNACK, Duration.END_OF_DRIVE)
